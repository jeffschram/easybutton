...
If using in conjunction with another Symbolset (ie. Symbolicons Block), include a reference to both CSS files (default set should be last) and add the secondary font's CSS class (ie. ".ss-symbolicons-block") where desired.

    <link href="webfonts/ss-symbolicons-block.css" rel="stylesheet" />
    <link href="webfonts/ss-symbolicons-line.css" rel="stylesheet" />
    ...
    <i class="ss-icon">Star</i>
    <i class="ss-icon ss-symbolicons-block">Star</i>
